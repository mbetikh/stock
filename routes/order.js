	...
	router.get('/showOrder', function(req,res){
	          ...
	          orderMgr.getOrder(req.body,function(result){
	  	         ...
	  	         orderMgr.getOrdd(req.body,function(result2,result1){
	  	         	 ...
	  	         	 orderMgr.getOrderInfo(function(resultz,resultw){
	  	         	 
	                //console.log(resultw);
	                //objects = [resultz, resultw]
	                //console.log([resultz,resultw]);
	               
	                //console.log(obj);
	                // resultz.merge(resultw);
	                res.render('showOrder',{title: 'أضافة موظف',ord:result,ordd:result2,emp:result3,info1:resultz,info2:resultw});
	...
	router.get('/delete/:id', function(req,res){
	  orderMgr.deleteOrder(req.params.id,function(result){
	   res.send(result);
	   });
	});
